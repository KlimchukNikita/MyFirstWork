package com.myfirstwork.myfirstwork.activity.fragment;
...
import com.myfirstwork.myfirstwork.view.AutoFitTextureView;
    ...
    private void openCamera(int width, int height) {
        ...
        try {
            ...
            if (orientation == Configuration.ORIENTATION_LANDSCAPE) {
                mTextureView.setAspectRatio(displayMetrics.heightPixels, displayMetrics.widthPixels);
            } else {
                mTextureView.setAspectRatio(displayMetrics.widthPixels, displayMetrics.heightPixels);
            }
            configureTransform(width, height);
