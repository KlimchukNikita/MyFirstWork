...
import com.myfirstwork.myfirstwork.databinding.ItemTextBinding;
...
public class AdapterList extends BaseAdapter implements Filterable {
    ...
    public AdapterList(List<String> strings){
        mData=strings;
        mStringFilterList=strings;
    }
    @Override
    public int getCount() {
        return mData.size();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        itemTextBinding.stringName.setText(mData.get(position));

        return itemTextBinding.getRoot();
    }
